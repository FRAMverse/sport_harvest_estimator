...
textInput("custom_start", label = "Custom Start Date\n(MM-DD format)",
          value = "09-01", width = '100%')
textInput("custom_end", label = "Custom End Date\n(MM-DD format)",
          value = "09-30", width = '100%')
actionButton(inputId = "run_custom", label = "Recalculate custom time period")
...
renderValueBox({
  valueBox(
    value = paste0("Weekday: ", format(round(wday_harvest()), big.mark = ","), " harvest"),
    icon = "fa-fish")
})

renderValueBox({
  valueBox(
    value = paste0("Weekend: ", format(round(wend_harvest()), big.mark = ","), " harvest"),
    icon = "fa-fish")
})
...
renderValueBox({
  valueBox(
    value = paste0("Total: ",
                   format(round(wday_harvest()+wend_harvest()), big.mark = ","), " harvest"),
    icon = "fa-fish")
})
...
renderPlot({
  ...
  if(input$use_custom_strata){
    time_label = paste0("Custom time period: ", input$custom_start, " to ", input$custom_end)
  }
