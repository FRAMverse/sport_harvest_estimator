                   ...
                   if (length(saved_years) == 0 | !setequal(saved_years, input$years) | !setequal(saved_regs, input$msf)) {
                     mean_harvest <- pssp_at() |>
                       ...
                       mutate(
                         ...
                         coho_ad_k = coho_104_ad_ret + (coho_104_uk_ret  * (
                           coho_104_ad_ret / (coho_104_ad_ret + coho_104_um_ret)
                         )),
                         coho_ad_k = replace_na(coho_104_ad_ret, 0),
                         coho_um_k = coho_104_um_ret + (coho_104_uk_ret * (
                           coho_104_um_ret /  (coho_104_ad_ret + coho_104_um_ret)
                         )),
