...
radioButtons("focal_ts", label = "Focal Timestep",
             choiceValues = c(1:5,-99), 
             choiceNames = c(paste(1:5, c("Jan-Jun","Jul","Aug","Sep","Oct-Dec"), sep = ":"), "Custom Strata"), 
...
### Custom Strata: mean daily harvest for custom dates

Only used if "Focal Timestep" is set to "Custom Strata". Press button to calculate.
...
actionButton(inputId = "run_custom", label = "Calculate Custom Strata")
```
...
observeEvent(ignoreInit = TRUE,
               ...
               input$run_custom),
             {
               ...
               if(input$focal_ts == -99 & 
                 ...
                 updateRadioButtons(inputId = 'focal_ts', selected = 4)
               } else {
      ...
      Defaulting to whatever data available'
                   ...
                   if(input$focal_ts != -99){ ## normal timesteps
...
renderPlot({
  ...
  time_label = case_when(input$focal_ts == 1 ~ "1: Jan-Jun",
                          ...
                          input$focal_ts == -99 ~ paste0("Custom Strata: ",
                                                         input$custom_start,
                                                         " to ", 
                                                         input$custom_end)
  )
